    ...
    <div>
      <BrowserRouter>
        ...
        <div
          style={
            navbarSide === true
              ? { width: "82vw", position: "fixed", left: "19vw", top: "60px",background:"#20232A",height:"94vh",padding:"10px 20px",overflow:"scroll" }
              : { width: "100vw", position: "block", left: "0vw", top: "60px",background:"#20232A",height:"94vh",padding:"10px 20px" }
          }
        >
          <Routes>
          ...
          <p style={{color:"white",margin:"100px 0px 30px 0px",textAlign:"center",width:"100%"}} >All Right Reseved @ 2023 by ShubhamJoshii.com</p>
        </div>
      </BrowserRouter>
    </div>
  );
